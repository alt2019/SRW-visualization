...
// import * from "clusterize.js"
	...
	document.addEventListener("mouseover", (event) => {
		...
		if ([...event.target.classList].includes("unclusterized-cube")     ) mouseOverActivatedCube(event); // works
		if ([...event.target.classList].includes("clusterized3d-cube")     ) mouseOverActivatedCube(event); // works
	...
	document.addEventListener("mouseout", (event) => {
		...
		if ([...event.target.classList].includes("unclusterized-cube")     ) mouseOutActivatedCube(event); // works
		if ([...event.target.classList].includes("clusterized3d-cube")     ) mouseOutActivatedCube(event); // works
	});
